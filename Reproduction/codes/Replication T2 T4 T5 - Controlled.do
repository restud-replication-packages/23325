/************************************************
TABLES 2, 4 AND 5 - Controlled regressions

Description: this files creates all the DID results 11 years after graduation for both samples, one by one: includes
...
global name Replication_DID_T2_4_5_contolled
...
*Comments explaining the commands appear for the first variable (University attendance). The rest of the coefficients are calculated in an identical way.
...
*this command was used to find the boostrap standard errors				
...
local N1 = e(N)
			di "number of unweighted observations"

**this regression documents the mean of the variable among untreated schools for the year 2000 as well as documents the unweighted regression in the log file (there is a seperate file that writes these results to file.)
			sum A_12_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N2 = e(N)
di "number of unweighted observations"
sum uni_12_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 	
...
local N3 = e(N)
di "number of unweighted observations"
sum B_12_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N4 = e(N)
di "number of unweighted observations"
sum col_12_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N5 = e(N)
di "number of unweighted observations"
sum E_12_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N6 = e(N)
		di "number of unweighted observations"
sum educ_12_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N7 = e(N)
di "number of unweighted observations"
sum sum_wage_11_afterSchoola if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 		
...
local N8 = e(N)
di "number of unweighted observations"
sum work_11_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
*for regular DID
 ...
 local pp2 = 0	
	...
	*xtile psum_wage_2011a = sum_wage_11_afterSchoola, nquantiles(100) 
			...
			sum pctle_wage_11_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 [fweight=hoodWeight]
...
local N9 = e(N)
di "number of unweighted observations"
sum pctle_wage_11_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N10 = e(N)
di "number of unweighted observations"
sum avt_11_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N11 = e(N)
di "number of unweighted observations"
sum avt_tot_11_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
di "number of unweighted observations"
sum months_11_afterSchool if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
di "number of unweighted observations"
sum married if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N14 = e(N)
di "number of unweighted observations"
sum kids if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N15 = e(N)
di "number of unweighted observations"
sum yeladim if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N16 = e(N)
di "number of unweighted observations"
sum age_at_marriage_y if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N17 = e(N)
di "number of unweighted observations"
sum age_at_marriage if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N18 = e(N)
di "number of unweighted observations"
sum age_at_first_birth_y if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
local N19 = e(N)
di "number of unweighted observations"
sum age_at_first_birth if year==2000 & treatment==1 & `sample' == 1 & `group' == 1 
...
* This section was used to calculate the effect on high school outcomes - grades, credits, drop out rate, etc. It is commented out as the relevant data could not be published.		
********************************************************
...
/*
 ...
 local pp16 = 0
	...
	*Write DID results to file
			...
			outsheet using "results/automatic//Table2_4_cont_`sample'.csv", replace comma
